...
class Logistic_Regression:
    ...
    def train(self, X_train, y_train, X_test, y_test, print_cost = False, print_score = False):
        SGDClf = SGDClassifier(max_iter = self.n_iter, alpha = self.regularizer_l2)
        ...
        self.weights = SGDClf.coef_
        self.bias = SGDClf.intercept_
...
plt.savefig('../Results/eta_lmd_train_acc_LG_SGD_sklearn.png')
...
ax.set_ylabel("$\eta$")
ax.set_xlabel("$\lambda$")
plt.savefig('../Results/eta_lmd_test_acc_LG_SGD_sklearn.png')
